...
std::string ToStr::to_str(EpArr& ep_arr) { return print_arr<uint32_t>(ep_arr.arr, ep_arr.m_arr_c); }

std::string ToStr::to_str(OffArr& off_arr) { return print_arr<uint32_t>(off_arr.arr, off_arr.arr_c()); }
